$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("file:src/test/java/hunb/mutation_pi/systemTest/groupMessageFeature/GroupMessage.feature");
formatter.feature({
  "name": "Csoport üzenetek",
  "description": "",
  "keyword": "Jellemző"
});
formatter.scenario({
...
formatter.match({
  "location": "hunb.mutation_pi.systemTest.groupMessageFeature.GroupMessageSteps.newGroup()"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "a csoport megszólítása 0, a csoport válasza: \"HELLO!\"",
  "keyword": "Amennyiben "
});
formatter.match({
  "location": "hunb.mutation_pi.systemTest.groupMessageFeature.GroupMessageSteps.groupMessage(int,java.lang.String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "a csoport megszólítása 1, a csoport válasza: \"GOOD BYE!\"",
  "keyword": "Amennyiben "
});
formatter.match({
  "location": "hunb.mutation_pi.systemTest.groupMessageFeature.GroupMessageSteps.groupMessage(int,java.lang.String)"
...
formatter.uri("file:src/test/java/hunb/mutation_pi/systemTest/groupSearchFeature/GroupSearch.feature");
formatter.feature({
